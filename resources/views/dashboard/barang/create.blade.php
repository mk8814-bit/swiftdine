...
@section('content')
    <div class="header-action"
        ...
        <div>
            <h2 style="font-weight: 800; color: var(--brand-dark); font-size: 1.8rem; margin-bottom: 5px;">Tambah Barang
            </h2>
            <p style="color: #666;">Silakan masukkan detail barang beru.</p>
        </div>
    ...
    <div
        ...
        <form action="{{ route('dashboard.barang.store') }}" method="POST">
            ...
            <div style="margin-bottom: 25px;">
                ...
                <input type="number" name="harga" value="{{ old('harga') }}" required min="0" placeholder="Contoh: 15000"
                    style="width: 100%; padding: 12px; border: 1px solid #ddd; border-radius: 8px; font-size: 1rem;">
                @error('harga') <span
                    style="color: #E53935; font-size: 0.85rem; margin-top: 5px; display: block;">{{ $message }}</span>
                @enderror
            ...
            <button type="submit" class="btn-primary" style="width: 100%; padding: 12px; font-size: 1.1rem;">Simpan
                Barang</button>
        </form>
    </div>
@endsection